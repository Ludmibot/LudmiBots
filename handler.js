...
global.dfail = (type, m, conn) => {
    ...
    let prep = generateWAMessageFromContent(m.chat, { extendedTextMessage: { text: msg, contextInfo: { externalAdReply: { title: '[ ⚠ ] 𝐀𝐕𝐈𝐒𝐎 - 𝐀𝐋𝐄𝐑𝐓𝐀', body: 'Gabi Bot' , thumbnail: imagen1, sourceUrl: 'https://instagram.com/ventas_bot.thezero?igshid=MzNlNGNkZWQ4Mg==' }}}}, aa)
